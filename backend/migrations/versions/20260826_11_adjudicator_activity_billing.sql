...
CREATE TABLE adjudicator_study_contracts (
...
CREATE INDEX ix_adjudicator_study_contracts_upn ON adjudicator_study_contracts(adjudicator_upn);
CREATE TABLE adjudicator_committee_memberships (
...
CREATE TABLE adjudication_activity_ledger (
    id VARCHAR(36) PRIMARY KEY, adjudicator_upn VARCHAR(255) NOT NULL, study_code VARCHAR(80) NOT NULL,
...
CREATE INDEX ix_activity_ledger_upn_date ON adjudication_activity_ledger(adjudicator_upn, event_at);
