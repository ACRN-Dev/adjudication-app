...
export default function InstructionBanner({ step }) {
  const instructions = {
    1: {
      title: "Select an Assigned Patient",
    ...
    2: {
      title: "Review Clinical Evidence & System Derivation",
    ...
    3: {
      title: "Approve Clinical Narrative & Record Adjudication (FORM-ADJ-15A/15B)",
    ...
    4: {
      title: "Adjudication Records Signed & Locked",
      description: "Your visit adjudications are signed and locked for concordance checking. Finalized cases can be downloaded for eTMF filing, or you can return to the queue for the next case."
    }
  };
